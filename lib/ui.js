...
export function Container(
  ...
  return (space) => {
    ...
    if (justify == "space-between") {
      ...
      spacedElements = [
        ...addRowsCols([], getRowCol({ flex: spaceBefore, perp:usedSize.perp})), // space before
        ...renderedElements,
        ...addRowsCols([], getRowCol({ flex: spaceAfter, perp: usedSize.perp}))   // space after
      ];
    }
