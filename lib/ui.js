...
export function Container(
  ...
  return (space) => {
    ...
    if (justify == "space-between") {
      // console.log(spaceBetween, lastSpaceBetween);
    }

    if (justify == "space-between") {
      console.log(Array(lastSpaceBetween).map(() => "Yo")); //Space(usedSize.perp)));
      console.log(
        rendered.flat().map((e) => e.textContent),
        spaceRem,
        spaceBetween,
        lastSpaceBetween
      );
    ...
    if (justify == "space-between") console.log(joinedLines);
